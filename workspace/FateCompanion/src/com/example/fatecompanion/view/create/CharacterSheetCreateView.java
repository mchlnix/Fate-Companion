...
public class CharacterSheetCreateView extends Activity {
	...
	protected void onStart()
	{
		...
		this.setTitle( "Generic für " + CharacterController.getInstance(getApplicationContext()).getCharacterByID( this.characterID ).getName()
