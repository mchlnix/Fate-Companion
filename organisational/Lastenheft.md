...
- Nutzer müssen während des Betriebs des Systems den aktiven Charakter (aktiv := dessen Character Sheets momentan betrachtet und editiert werden kann) wechseln können.

Das Programm soll bis Ende des Jahres 2015 fertiggestellt werden. Support soll für mindestens ein (1) weiteres Jahr angeboten werden. Folgeaufträge zur Erweiterung der Applikation sind bei entsprechender Qualität sehr wahrscheinlich.
...
- LF 0210 - Kampagne erstellen: Erstellung einer Kampagne durch Eingabe aller erforderlichen Daten und eventueller optionaler Daten zur näheren Beschreibung.
- LF 0220 - Charakter erstellen: Erstellung eines Charakters innerhalb einer bereits erstellten Kampagne durch Eingabe der erforderlichen Daten. Über die Kampagne wird dabei das zu verwendende System (damit auch die zu verwendende Character Sheet Vorlage) bestimmt. Die Charaktererstellung soll dabei in kleinen Schritten unterstützt werden.
- LF 0230 - Character Sheet bearbeiten: Öffnen einer weiteren Ansicht, in der die Daten des aktiven Character Sheets bearbeitet werden können.
- LF 0240 - Character Sheet Bearbeitung beenden: Schließt die Bearbeitung der Daten ab und führt den Nutzer zurück in die Übersicht der Daten des Charakters. Die Daten werden dabei auf dem neuen aktuellen Stand angezeigt.
...
- LD 0220 - Beschreibung: kurze Beschreibung (Persönlichkeit, Aussehen, ...)
